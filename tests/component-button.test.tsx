...
describe('Button component', () => {
  test('render', () => {
    ...
    expect(allDefault.className).toEqual('material-button-text');
    expect(elevated.className).toEqual('material-button-elevated');
    expect(filled.className).toEqual('material-button-filled');
    expect(filled.firstElementChild).not.toBeNull();
    expect(outlined.className).toEqual('material-button-outlined');
    expect(text.tagName).toEqual('A');
    expect(text.className).toEqual('material-button-text');
    expect(tonal.className).toEqual('material-button-tonal');
  });
});
